"""Random sample 10 items from 2024_Catalog."""
import random
...
# Get all data
result = sheets.values().get(spreadsheetId=GOOGLE_SHEETS_ID, range='2024_Catalog!A1:Q200').execute()
...
print('2024_Catalog 무작위 10개 샘플 분석')
print('=' * 100)
